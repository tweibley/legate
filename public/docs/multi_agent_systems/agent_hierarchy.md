...
The ADK supports a hierarchical agent structure, allowing agents to be composed of other agents (sub-agents). This enables the creation of complex systems where a parent agent coordinates the work of specialized child agents.
...
You can define sub-agents within an `ADK::AgentDefinition` using the `sub_agents_define` DSL method.
