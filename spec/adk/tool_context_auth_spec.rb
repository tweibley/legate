...
RSpec.describe ADK::ToolContext do
  ...
  let(:token_manager) { instance_double('ADK::Auth::TokenManager') }
  ...
  describe '#get_token' do
    let(:exchanged_credential) { instance_double('ADK::Auth::ExchangedCredential') }
  ...
  describe '#refresh_token' do
    let(:token) { instance_double('ADK::Auth::ExchangedCredential') }
    let(:refreshed_token) { instance_double('ADK::Auth::ExchangedCredential') }
  ...
  describe '#store_token' do
    ...
    it 'stores token in token store' do
      ...
      expect(ADK::Auth::ToolIntegration).to receive(:generate_cache_key).with(api_key_scheme, api_key_credential).and_return(cache_key)
