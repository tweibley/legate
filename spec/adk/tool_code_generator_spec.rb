# File: spec/adk/tool_code_generator_spec.rb
# frozen_string_literal: true

require 'spec_helper'
require 'adk/tool_code_generator'

RSpec.describe ADK::ToolCodeGenerator do
  ...
  before(:each) do
    ...
    ADK::GlobalToolManager.register_tool(ADK::Tools::Calculator)
  end
  ...
  describe '.generate' do
    context 'with a registered tool' do
      it 'generates valid Ruby code for the echo tool' do
        ...
        expect(code).to include("require 'adk/tool'")
        ...
        expect(code).to include('ADK::GlobalToolManager.register_tool')
      end
    ...
    context 'generated code structure' do
      ...
      it 'includes generation timestamp comment' do
        expect(code).to include('# Generated from ADK Web UI on')
      end

      it 'wraps class in ADK::Tools module' do
        expect(code).to include('module ADK')
