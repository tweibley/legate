# File: spec/adk/agent_code_generator_spec.rb
# frozen_string_literal: true

require 'spec_helper'
require 'adk/agent_code_generator'

RSpec.describe ADK::AgentCodeGenerator do
  describe '.generate' do
    context 'with a basic LLM agent' do
      ...
      it 'generates valid Ruby code' do
        ...
        expect(code).to include("require 'adk'")
        expect(code).to include('ADK::AgentDefinition.new.define')
        ...
        expect(code).to include('ADK::GlobalDefinitionRegistry.register(definition)')
      end
