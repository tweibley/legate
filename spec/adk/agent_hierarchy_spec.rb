...
# File: spec/adk/agent_hierarchy_spec.rb
require 'spec_helper'
require 'adk/agent'
require 'adk/planner'
...
RSpec.describe "ADK::Agent Hierarchy Methods" do
  ...
  def create_agent_with_name(name, parent = nil)
    ...
    agent = ADK::Agent.new(definition: definition, session_service: session_service_double)
