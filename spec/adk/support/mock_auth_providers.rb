  ...
  module Test
    module Support
      ...
      module MockAuthProviders
        ...
        class Config
          attr_accessor :token_expiry_seconds, :use_custom_claims, :custom_claims
          attr_accessor :jwks_uri, :authorization_endpoint, :token_endpoint, :userinfo_endpoint
          attr_accessor :issuer, :client_id, :client_secret, :redirect_uri
        ...
        class MockOAuth2Provider < MockProvider
          ...
          def handle_client_credentials_grant(params)
