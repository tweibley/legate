...
RSpec.describe 'Legate Callbacks' do
  ...
  describe Legate::Callbacks::CallbackContext do
    subject(:context) do
      described_class.new(
  ...
  describe Legate::ToolContext do
    subject(:context) do
      described_class.new(
        session_id: session_id,
        user_id: user_id,
  ...
  describe 'Agent callback execution' do
    ...
    before do
      ...
      Legate::GlobalToolManager.register_tool(TestTool)
    end
    ...
    it 'executes before_agent_callback at the start of run_task' do
      ...
      allow_any_instance_of(Legate::Planner).to receive(:plan).and_return({ steps: [] })
    ...
    it 'allows before_agent_callback to override normal execution' do
      ...
      planner_mock = instance_double(Legate::Planner)
    ...
    it 'executes before_tool_callback before tool execution' do
      ...
      allow_any_instance_of(Legate::Planner).to receive(:plan).and_return({
    ...
    # have been moved to spec/legate/planner_callbacks_spec.rb
  end
end
