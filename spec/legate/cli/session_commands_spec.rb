...
# require 'spec_helper'
# require 'legate/cli/session_commands'
# require 'legate/session_service/redis'
# require 'legate/session'
# require 'timecop'
# require 'thor'

# RSpec.describe Legate::CLI::SessionCommands do
#   let(:session_service_double) { instance_double(Legate::SessionService::Redis) }
...
#     allow(Legate::SessionService::Redis).to receive(:new).and_return(session_service_double)
...
#       let(:session1) do
#         Legate::Session.new(id: 'sess_1', app_name: 'app1', user_id: 'user1', events: [])
#       end
#       let(:session2) do
#         Timecop.freeze(Time.now - 3600) do
#           Legate::Session.new(id: 'sess_2', app_name: 'app2', user_id: 'user2', events: [])
#         end
#       end
...
#       let(:session) do
#         Legate::Session.new(id: session_id, app_name: 'show_app', user_id: 'show_user', events: [])
#       end
...
#       let(:events) do
#         [
#           Legate::Event.new(role: :user, content: 'Hello'),
#           Legate::Event.new(role: :agent, content: 'Hi there!')
#         ]
#       end
#       let(:session) do
#         Legate::Session.new(id: session_id, app_name: 'show_app', user_id: 'show_user', events: events)
#       end
...
#       Legate::Session.new(id: session_id, app_name: 'delete_app', user_id: 'delete_user', events: [])
#     end
...
#     let(:agent_commands_double) { instance_double(Legate::CLI::AgentCommands) }
#     let(:existing_session_id) { 'sess_existing_123' }
#     let(:new_session_id) { 'sess_new_456' }
#     let(:existing_session) do
#       Legate::Session.new(id: existing_session_id, app_name: agent_name, user_id: 'cli_user', events: [])
#     end
#     let(:new_session) do
#       Legate::Session.new(id: new_session_id, app_name: agent_name, user_id: 'cli_user', events: [])
#     end

#     before do
#       allow(Redis).to receive(:new).and_return(redis_double)
#       allow(Legate::CLI::AgentCommands).to receive(:new).and_return(agent_commands_double)
...
#           .with("legate:agent:#{agent_name}", 'description', 'tools', 'model')
