...
RSpec.describe Legate::Auth::Schemes::OAuth2 do
  ...
  describe '#initialize' do
    ...
    it 'parses scopes from a string' do
      ...
      expect(scheme.scopes).to eq(%w[profile email openid])
    end
  end
  ...
  describe '#build_authorization_uri' do
    let(:config) { Legate::Auth::Config.new(scheme: scheme, credential: credential) }
    ...
    it 'does not include PKCE parameters when disabled' do
      ...
      no_pkce_config = Legate::Auth::Config.new(
  ...
  describe '#exchange_token' do
    ...
    it 'raises an error if response_uri is missing' do
      ...
      }.to raise_error(Legate::Auth::TokenExchangeError)
    end
  ...
  describe '#refresh_token' do
    ...
    it 'raises an error if the refresh token is missing' do
      ...
      }.to raise_error(Legate::Auth::TokenRefreshError)
    end
