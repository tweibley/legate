...
require 'legate/auth/schemes/google_service_account'
require 'securerandom'
require 'webmock/rspec'
require 'base64'
require 'jwt'

RSpec.describe Legate::Auth::Schemes::GoogleServiceAccount do
  ...
  describe '#fetch_token' do
    ...
    it 'validates required fields in service account key' do
      ...
      invalid_credential = Legate::Auth::Credential.new(
        auth_type: :google_service_account,
      ...
      }.to raise_error(Legate::Auth::CredentialError, /missing required fields/)
    end
    ...
    it 'validates the type field in service account key' do
      ...
      expect {
        scheme.fetch_token(invalid_credential)
      }.to raise_error(Legate::Auth::CredentialError, /Invalid key type/)
    end
    ...
    it 'includes subject if provided in service account key' do
      ...
      credential_with_sub = Legate::Auth::Credential.new(
        auth_type: :google_service_account,
