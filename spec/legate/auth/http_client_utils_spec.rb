...
RSpec.describe Legate::Auth::HttpClientUtils do
  ...
  let(:api_key_credential) { Legate::Auth::Credential.new(auth_type: :api_key, api_key: 'test-api-key') }
  ...
  describe '.configure_connection' do
    ...
    it 'adds middleware to the connection' do
      ...
      expect(connection.data[:middlewares]).to include(Legate::Auth::ExconMiddleware)
      expect(connection.data[:auth_middleware]).to be_a(Legate::Auth::ExconMiddleware)
    end
