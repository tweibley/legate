...
# File: spec/legate/tools/calculator_spec.rb
require 'spec_helper'

RSpec.describe Legate::Tools::Calculator do
  ...
  describe '#execute' do
    ...
    context 'with division by zero' do
      ...
      it 'raises ToolArgumentError' do
        expect {
          tool.execute(params)
        }.to raise_error(Legate::ToolArgumentError, /Division by zero/i)
      end
    end
    ...
    context 'with an unsupported operation' do
      ...
      it 'raises ToolArgumentError' do
        expect {
          tool.execute(params)
        }.to raise_error(Legate::ToolArgumentError, /Unsupported operation: 'modulo'/i)
      end
    end
    ...
    context 'with non-numeric input for operands' do
      ...
      it 'raises ToolArgumentError' do
        expect {
          tool.execute(params)
        }.to raise_error(Legate::ToolArgumentError, %r{expected Numeric/Float})
      end
    end
    ...
    context 'with nil input causing TypeError during Float conversion' do
      ...
      it 'raises ToolArgumentError wrapping the TypeError' do
        ...
        expect {
          tool.execute(params)
        }.to raise_error(Legate::ToolArgumentError, /Invalid numeric input.*Op2: ''/i) # nil becomes ''
      end
    end
    ...
    context 'with missing required parameters' do
      ...
      it 'raises an Legate::ToolArgumentError' do
        expect { tool.execute(params) }.to raise_error(Legate::ToolArgumentError, /Missing required parameters for tool 'calculator': operand2/)
      end
    end
  end
end
