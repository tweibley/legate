...
# File: spec/legate/tools/random_number_tool_spec.rb
require 'spec_helper'

RSpec.describe Legate::Tools::RandomNumberTool do
  ...
  describe '#execute' do
    ...
    context 'with min greater than max' do
      ...
      it 'raises ToolArgumentError' do
        expect {
          tool.execute(params)
        }.to raise_error(Legate::ToolArgumentError, /Min value \(100\) cannot be greater than Max value \(90\)/)
      end
    end
    ...
    context 'with non-integer input for min' do
      ...
      it 'raises ToolArgumentError' do
        expect {
          tool.execute(params)
        }.to raise_error(Legate::ToolArgumentError, /expected Integer/)
      end
    end
