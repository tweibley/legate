...
require 'legate/session_service/in_memory' # Corrected path

RSpec.describe Legate::Configuration::Webhooks do
  ...
  describe '#register_route' do
    ...
    it 'yields a RouteConfig object to the block' do
      ...
      expect(yielded_config).to be_a(Legate::Configuration::Webhooks::RouteConfig)
    end
  ...
  describe '#static_routes' do
    it 'returns a hash of registered routes' do
      ...
      expect(config.static_routes.values).to all(be_a(Legate::Configuration::Webhooks::RouteConfig))
    end
  ...
  describe Legate::Configuration::Webhooks::RouteConfig do
