...
module ADK
  ...
  class Agent
    ...
    def initialize(definition:, session_service: nil, planner_override: nil, sub_agents: nil)
      ...
      mcp_servers_config = definition.mcp_servers || []
      # Ensure config is an array
      mcp_servers_config = [] unless mcp_servers_config.is_a?(Array)

      @mcp_connection_manager = ADK::Mcp::ConnectionManager.new(
    ...
    def connect_mcp_servers
      @mcp_connection_manager.connect_all
    end
