...
require_relative 'plan_executor' # Added PlanExecutor
...
module ADK
  ...
  class Agent
    ...
    def initialize(definition:, session_service: nil, planner_override: nil, sub_agents: nil)
      ...
      @plan_executor = ADK::PlanExecutor.new(agent: self) # Initialize PlanExecutor
    ...
    def run_task(session_id:, user_input:, session_service:)
      ...
      begin
        ...
        result_hash = @plan_executor.execute(plan, session, session_service, invocation_id)
