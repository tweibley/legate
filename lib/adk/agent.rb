...
require_relative 'plan_executor' # Added for PlanExecutor
...
module ADK
  ...
  class Agent
    ...
    # Executes a plan, delegating to PlanExecutor
    ...
    # @param invocation_id [String] The invocation ID.
    ...
    def execute_plan(plan, session, session_service, invocation_id)
      # Create an executor instance with self as agent
      executor = ADK::PlanExecutor.new(
        agent: self,
        session_service: session_service,
      ...
      # Delegate execution
      executor.execute_plan(plan, session, invocation_id)
    end
