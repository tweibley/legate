# File: lib/adk/agent_code_generator.rb
  ...
  module AgentCodeGenerator
    ...
    def self.generate(definition)
      ...
      code = <<~RUBY
        ...
        # Agent: #{name}
        # Generated from ADK Web UI on #{Time.now.strftime('%Y-%m-%d %H:%M:%S')}
