...
module ADK
  # Responsible for executing a plan generated by the Planner.
  # Moves execution logic out of the Agent class.
  class PlanExecutor
    # @param agent [ADK::Agent] The agent instance.
    # @param session_service [ADK::SessionService::Base] The session service.
    # @param tool_registry [ADK::ToolRegistry] The tool registry.
    ...
    def execute_plan(plan, session, invocation_id)
    ...
    def execute_step(step, session, invocation_id = nil)
      ...
      # Note: We access private method build_agent_auth_config from agent using send
      agent_auth_config = @agent.send(:build_agent_auth_config) if @agent.respond_to?(:build_agent_auth_config, true)
