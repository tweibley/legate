...
- **Command Line Interface**: Easy-to-use CLI for running agents and web UI. See [CLI Usage](docs/cli/adk_cli_usage.md)
...
- **Asynchronous Job Handling**: Support for long-running tasks via background jobs (using Sidekiq). See [Async Jobs with Sidekiq](docs/guides/async_jobs_sidekiq.md)
...
See the detailed documentation: [docs/guides/async_jobs_sidekiq.md](docs/guides/async_jobs_sidekiq.md)
...
For detailed configuration and usage, please refer to the [Webhook Guide](docs/guides/inbound-webhook-to-agent.md).