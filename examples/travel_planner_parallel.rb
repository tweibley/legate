...
# Run with: bundle exec ruby examples/travel_planner_parallel.rb
#
...
require_relative '../lib/adk/agents/parallel_agent' # Required for ParallelAgent
require_relative '../lib/adk/agents/sequential_agent' # Required for the final SequentialAgent
...
flight_agent_def = ADK::AgentDefinition.new.define do |a|
...
accommodation_agent_def = ADK::AgentDefinition.new.define do |a|
...
attractions_agent_def = ADK::AgentDefinition.new.define do |a|
...
weather_agent_def = ADK::AgentDefinition.new.define do |a|
...
travel_planner_def = ADK::AgentDefinition.new.define do |a|
  ...
  a.agent_type :parallel # Important! This tells ADK to use ParallelAgent
  a.parallel_sub_agents [:destination_research, :flight_search, :accommodation_search, :attractions_research, :weather_forecast]
end

# Register all agents globally
ADK::GlobalDefinitionRegistry.register(destination_agent_def)
ADK::GlobalDefinitionRegistry.register(flight_agent_def)
ADK::GlobalDefinitionRegistry.register(accommodation_agent_def)
ADK::GlobalDefinitionRegistry.register(attractions_agent_def)
ADK::GlobalDefinitionRegistry.register(weather_agent_def)
...
flight_agent = ADK::Agent.new(definition: flight_agent_def, session_service: session_service)
accommodation_agent = ADK::Agent.new(definition: accommodation_agent_def, session_service: session_service)
attractions_agent = ADK::Agent.new(definition: attractions_agent_def, session_service: session_service)
weather_agent = ADK::Agent.new(definition: weather_agent_def, session_service: session_service)
...
travel_planner = ADK::Agents::ParallelAgent.new(
