# File: examples/mcp_server_async_tools.rb
# frozen_string_literal: true

# --- Example: MCP Server with Async ADK Tools ---
#
...
#   - Start a Sidekiq worker: bundle exec sidekiq -r ./examples/workers/sleepy_worker.rb
#   - Run this script: bundle exec ruby examples/mcp_server_async_tools.rb
#
...
class CheckJobStatusToolWrapper < FastMcp::Tool
  ...
  def call(args)
    tool = ADK::Tools::CheckJobStatusTool.new
    context = ADK::ToolContext.new(
      session_id: 'mcp-session',
      user_id: 'mcp-user',
      app_name: 'mcp-server',
