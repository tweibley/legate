...
# Example of using ADK::Auth with OpenWeatherMap API
#
# This example demonstrates different ways to authenticate with OpenWeatherMap API
# using both direct Excon calls and ADK::Auth middleware.
#
# Usage:
#   ruby examples/auth/openweather_api.rb

require 'bundler/setup'
require 'adk'
require 'adk/auth'  # Explicitly require the auth module
require 'json'
require 'excon'
...
puts "\nDEMO 1: Direct API call with Excon (no ADK middleware)"
puts "------------------------------------------------------"
...
puts "\nDEMO 2: Using ADK::Auth to apply authentication manually"
puts "------------------------------------------------------"
...
begin
  ...
  # Use ADK::Auth::ToolIntegration to apply authentication to the request
...
puts "\nDEMO 4: Using ADK::Auth middleware (with fixed implementation)"
puts "---------------------------------------------------------"

begin
  puts "Creating connection with ADK::Auth middleware..."
  
  # Use the fixed middleware via ADK::Auth.create_api_key_connection
