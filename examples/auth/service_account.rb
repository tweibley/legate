...
#
# Usage:
#   ruby examples/auth/service_account.rb [path/to/service_account_key.json]
...
unless key_file_path
  ...
  puts "Usage: ruby examples/auth/service_account.rb [path/to/service_account_key.json]"
...
coordinator = ADK::Auth::Coordinators::ServiceAccountCoordinator.new(
  scheme: scheme,
...
begin
  token = ADK::Auth.authenticate_with_coordinator(coordinator)
