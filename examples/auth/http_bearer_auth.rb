...
# Example of using HTTP Bearer authentication with ADK
#
...
#
# Usage:
#   ruby examples/auth/http_bearer_auth.rb [token]
...
unless bearer_token
  ...
  puts "Usage: ruby examples/auth/http_bearer_auth.rb [token]"
...
expiring_token = ADK::Auth::ExchangedCredential.new(
  auth_type: :http_bearer,
...
puts "\n=== Example 3: Using with the ADK Excon Middleware ==="
...
puts "\n=== Example 4: Using with the ADK Tooling System ==="
# Example of a tool using bearer authentication
class BearerAuthExampleTool < ADK::Tool
