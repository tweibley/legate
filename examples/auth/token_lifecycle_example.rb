...
#
# Usage:
#   ruby examples/auth/token_lifecycle_example.rb [--scheme oauth2|service_account] [--demo-mode]
...
OptionParser.new do |opts|
  ...
  opts.on("--scheme SCHEME", ["oauth2", "service_account"], "Authentication scheme to demonstrate (oauth2, service_account)") do |scheme|
...
begin
  ...
  if !options[:demo_mode]
    puts "\nTip: Use --demo-mode to run with simulated credentials"
  end
  exit 1
end
...
puts "\nThis example shows how the ADK authentication system handles"
